...
RSpec.describe GramsController, type: :controller do
  describe "grams#show action" do
    it "should successfully display the show grams page if the gram is found" do
  ...
  describe "grams#update action" do
    ...
    it "should have 404 error if gram is not found" do
      user = FactoryGirl.create(:user)
      sign_in user
      patch :update, id: 'notanid', gram: {message: "Changed"}
      expect(response).to have_http_status(:not_found)
    end
  ...
  describe "grams#destroy action" do
    ...
    it "shouldn't let a user who did not create the gram delete a gram" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
      delete :destroy, id: gram.id
